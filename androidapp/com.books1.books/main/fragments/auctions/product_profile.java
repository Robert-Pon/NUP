...
public class product_profile extends Fragment {
    ...
    products_profile_in products_profile_in;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        profile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    editor.putString("id1", book.getString("person_id"));
                    editor.commit();
                } catch (JSONException e) {
                    e.printStackTrace();
                }
                products_profile_in.go_to_profile();
            }
        });
    ...
    public void onAttach(@NonNull Context context) {
        ...
        products_profile_in = (products_profile_in) context;
    }

    public interface  products_profile_in{
