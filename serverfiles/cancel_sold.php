...
if($i==1 && $id1 = $userID){
    ...
    if($resp1->fetch_object()->id==$userID){
        mysqli_query($conn, "UPDATE books SET seen = 'true', reservation = '0' WHERE id = '$id3' AND reservation = '1'");
        ...
        $responseObject1[$i3+1] = "0";
        mysqli_query($conn, "UPDATE people SET my_shopping = '".json_encode($responseObject1)."' WHERE id = '$id2'");
