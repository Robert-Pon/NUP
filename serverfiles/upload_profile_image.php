...
if($i==1 && $id1 = $userID){
    ...
    if($resp1->fetch_object()->id==$userID){   
        $name = "profile.jpg";
        if(!file_exists("xIsqweriosamuiwrunsdkjfkaurpwprofiles/$id1")){
            mkdir("xIsqweriosamuiwrunsdkjfkaurpwprofiles/$id1", 0777, true);
            move_uploaded_file($_FILES['image']['tmp_name'], "xIsqweriosamuiwrunsdkjfkaurpwprofiles/$id1/profile.jpg");
        }else if(!file_exists("xIsqweriosamuiwrunsdkjfkaurpwprofiles/$id1")){
            mkdir("xIsqweriosamuiwrunsdkjfkaurpwprofiles/$id1", 0777, true);
            move_uploaded_file($_FILES['image']['tmp_name'], "xIsqweriosamuiwrunsdkjfkaurpwprofiles/$id1/profile.jpg");
        }else{
            move_uploaded_file($_FILES['image']['tmp_name'], "xIsqweriosamuiwrunsdkjfkaurpwprofiles/$id1/profile.jpg");
